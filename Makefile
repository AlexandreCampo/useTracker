...
INC = 
CFLAGS = -Wall -std=c++11 `wx-config --cflags all` `pkg-config --cflags opencv` -I ./ -I ./plugins -I./capture -I./dialogs -pipe -DARUCO
RESINC = 
LIBDIR = 
LIB = 
LDFLAGS = `wx-config --libs --gl-libs` -lGL -lGLU -lglut -lpthread `pkg-config --libs opencv` `pkg-config --libs libavcodec libavformat libswscale libavutil` -ldl -lva -lbz2 -lz -lm -lpng -lx264 -lboost_program_options -lboost_system -lboost_filesystem -laruco -lbluetooth
...
$(OBJDIR_DEBUG)/dialogs/DialogAnthomology.o: dialogs/DialogAnthomology.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c dialogs/DialogAnthomology.cpp -o $(OBJDIR_DEBUG)/dialogs/DialogAnthomology.o
...
$(OBJDIR_DEBUG)/plugins/Anthomology.o: plugins/Anthomology.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c plugins/Anthomology.cpp -o $(OBJDIR_DEBUG)/plugins/Anthomology.o
...
$(OBJDIR_RELEASE)/dialogs/DialogAnthomology.o: dialogs/DialogAnthomology.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c dialogs/DialogAnthomology.cpp -o $(OBJDIR_RELEASE)/dialogs/DialogAnthomology.o
...
$(OBJDIR_RELEASE)/plugins/Anthomology.o: plugins/Anthomology.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c plugins/Anthomology.cpp -o $(OBJDIR_RELEASE)/plugins/Anthomology.o
